...
Citizen.CreateThread(function()
	...
	PerformHttpRequest("https://api.github.com/repos/chaixshot/RageUI/releases/latest", function(errorCode, resultData, resultHeaders)
		if errorCode == 200 then
			...
			if updateVersion ~= currentVersion then
				local function Do()
					...
					print("^5https://github.com/chaixshot/RageUI/releases/latest")
					if data.body then
						print("^3Changelog:")
						print("^7"..data.body)
					end
