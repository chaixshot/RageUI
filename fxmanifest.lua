...
client_scripts {
    ...
    "menu/components/Audio.lua",
    "menu/components/Enum.lua",
    "menu/components/Keys.lua",
    "menu/components/Rectangle.lua",
    "menu/components/Sprite.lua",
    "menu/components/Text.lua",
    "menu/components/Visual.lua",
