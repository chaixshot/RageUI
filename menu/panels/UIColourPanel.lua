...
function RageUI.ColourPanel(Title, Colours, MinimumIndex, CurrentIndex, Action, Index, Style)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Index == Index) then
            ...
            if (Hovered or LeftArrowHovered or RightArrowHovered) and (RageUI.Settings.Controls.Click.Active or CurrentMenu.Controls.Left.Active or CurrentMenu.Controls.Right.Active) then
